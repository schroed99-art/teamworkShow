...
## Phase 5.3 Vollausbau — Freier Zonen-Editor — Etappe 1–5 FERTIG (v1.0.44), Etappe 6 offen
...
- **🔜 Etappe 6 (Abschluss-Verifikation):** End-to-End am Emulator — ein Gerät auf `custom` mit 3-Zonen geschachteltem Baum stellen (per Dashboard-Editor oder devices.php-PUT), gerendert prüfen; Live-Änderung (Zone/Größe) → Activity-Neuerstellung im Sync-Intervall; `single` weiter ok; Format-Wechsel (Tablet/Phone-AVD) → Baum des jeweiligen Formats. Danach Phase 5.3 Vollausbau komplett.
