...
<style>
  ...
  .usermenu-btn:hover { border-color:var(--magenta,#ff006e); }
  .usermenu-avatar { width:24px; height:24px; border-radius:50%; background:var(--magenta,#ff006e); color:#fff;
  ...
  .usermenu-pop a.danger:hover { color:#fff; background:var(--magenta,#ff006e); }
</style>
<script>
